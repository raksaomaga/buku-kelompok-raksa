...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{minggu-02/figma-frame-kosong.png}
  \caption{Canvas Figma dengan satu frame kosong berukuran Web 1920.}
  \label{fig:figma-frame-kosong}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{minggu-02/wireframe-profil-diri.png}
  \caption{Wireframe halaman ``Profil Diri'' di Figma.}
  \label{fig:wireframe-profil-diri}
\end{figure}  
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{minggu-02/wireframe-portofolio.png}
  \caption{Wireframe halaman Portfolio di Figma (tampilan penuh).}
  \label{fig:wireframe-portofolio}
\end{figure} 
...
\begin{table}[htbp]
\centering
\caption{Evaluasi heuristik Google Penelusuran}
\label{tab:m02-eval}
...
Ya &
Prediksi pencarian muncul ketika pengguna mulai mengetik.
Respons ini memberikan umpan balik bahwa sistem menerima
dan merespons masukan pengguna. \\

Match Between System and Real World &
Ya &
Pengguna dapat mencari informasi menggunakan bahasa
sehari-hari. Ikon mikrofon pada pencarian suara sesuai
dengan aktivitas berbicara sehingga mudah dipahami. \\

Error Prevention &
Ya, sebagian &
Pelengkapan otomatis menyediakan saran kata atau frasa
sebelum pencarian dikirim. Fitur ini dapat mengurangi
peluang salah ketik, tetapi pengguna tetap perlu memastikan
saran yang dipilih sesuai dengan tujuannya. \\
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{minggu-02/webaim-contrast-checker.png}
  \caption{WebAIM Contrast Checker dengan hasil pengecekan.}
  \label{fig:webaim-contrast-checker}
\end{figure}
