...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{minggu-04/form-pendaftaran.png}
  \caption{Form pendaftaran akun yang memuat data diri, informasi akademik, dan catatan tambahan.}
  \label{fig:m04-form-pendaftaran}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-04/tabel-data.png}
  \caption{Tabel jadwal kuliah dan perbandingan nilai UTS di peramban.}
  \label{fig:m04-tabel-data}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-04/praktikum-section-form.png}
  \caption{Bagian form pada halaman gabungan Praktikum Minggu 4.}
  \label{fig:m04-praktikum-form}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-04/praktikum-section-tabel-multimedia.png}
  \caption{Bagian tabel dan multimedia yang memuat gambar, video, serta audio.}
  \label{fig:m04-praktikum-multimedia}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-04/latihan-survei-kepuasan.png}
  \caption{Hasil latihan mandiri form Survei Kepuasan mahasiswa terhadap layanan kampus.}
  \label{fig:m04-latihan-survei}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-04/latihan-data-buku.png}
  \caption{Hasil latihan mandiri tabel Data Buku yang dilengkapi sampul, delapan data buku, dan rata-rata harga.}
  \label{fig:m04-latihan-data-buku}
\end{figure}
