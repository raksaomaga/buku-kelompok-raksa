...
\begin{center}
  \includegraphics[width=0.85\linewidth]{minggu-05/hasil-selector.png}
  \captionof{figure}{Hasil \texttt{index.html} setelah menerapkan selector (judul navy, paragraf hijau, \emph{highlight} kuning, id merah, paragraf ungu di dalam div).}
  \label{fig:hasil-selector}
\end{center}
...
\begin{center}
  \includegraphics[width=0.85\linewidth]{minggu-05/box-model-devtools.png}
  \captionof{figure}{DevTools $\rightarrow$ tab \emph{Computed} yang menampilkan \emph{box model} salah satu kotak.}
  \label{fig:box-model-devtools}
\end{center}

\begin{center}
  \includegraphics[width=0.85\linewidth]{minggu-05/hasil-box.html.png}
  \captionof{figure}{Hasil \texttt{box.html} dengan dua kotak biru muda ber-\emph{border} navy dan jarak antar kotak.}
  \label{fig:hasil-box-html}
\end{center}
...
\begin{center}
  \includegraphics[width=0.85\linewidth]{minggu-05/hasil-tipografi.html.png}
  \captionof{figure}{Hasil \texttt{tipografi.html} dengan judul, sub judul, dan dua paragraf bergaya berbeda.}
  \label{fig:hasil-tipografi-html}
\end{center}
...
\begin{center}
  \includegraphics[width=0.85\linewidth]{minggu-05/hasil-profil.html.png}
  \captionof{figure}{Hasil latihan mandiri \texttt{profil.html} (kartu profil).}
  \label{fig:hasil-profil-html}
\end{center}
