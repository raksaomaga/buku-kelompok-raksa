...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-03/browser-elemen-dasar.png}
  \caption{Hasil \texttt{index.html} yang menampilkan elemen-elemen dasar HTML di peramban.}
  \label{fig:m03-elemen-dasar}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-03/profil-dengan-css.png}
  \caption{Halaman \texttt{profil.html} di peramban setelah dihubungkan dengan \texttt{style.css}.}
  \label{fig:m03-profil-css}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-03/w3c-validasi.png}
  \caption{Hasil pemeriksaan \texttt{profil.html} pada W3C HTML Validator tanpa \emph{error} atau \emph{warning}.}
  \label{fig:m03-w3c-validasi}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{minggu-03/tips-belajar-html.png}
  \caption{Hasil latihan mandiri halaman \texttt{tips.html} di peramban.}
  \label{fig:m03-tips-html}
\end{figure}
